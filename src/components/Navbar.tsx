        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="font-playfair font-bold text-xl md:text-2xl">
              <span className={isScrolled ? "text-foreground" : "text-white"}>Gopalan</span>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" className={`font-inter ${isScrolled ? "text-foreground" : "text-white"}`}>
              Sign In
            </Button>
            <Button variant="default" className="font-inter shadow-card hover:shadow-elegant">
              Login
            </Button>
          </div>
