      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 hover:bg-white/15 transition-all duration-300">
                  ...
                  <p className="font-inter text-sm text-white/70">Advancing indigenous breed conservation and genetic improvement</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 hover:bg-white/15 transition-all duration-300">
                  <h5 className="font-inter font-semibold mb-2 text-white">Scientific Excellence</h5>
                  <p className="font-inter text-sm text-white/70">Ensuring data quality for breeding program decisions</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-white/20 mt-12 pt-8 text-center animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <p className="font-inter text-white/60 mb-4">© 2024 Gopalan AI. Advancing agricultural technology for a better tomorrow.</p>
